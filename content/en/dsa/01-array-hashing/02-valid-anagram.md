---
title: Valid Anagram
tags: [dsa, array, hashing, string, easy, "#topic/dsa"]
date: 2024-12-19
difficulty: Easy
source: neetcode
...
- **Liên kết tới các bài liên quan:**
  - [group-anagrams](04-group-anagrams.md) - Ứng dụng kiểm tra anagram để nhóm các từ
  - [contains-duplicate](01-contains-duplicate.md) - Cũng dùng hash map để đếm tần suất
  - [top-k-frequent-elements](05-top-k-frequent-elements.md) - Đếm tần suất và sắp xếp
