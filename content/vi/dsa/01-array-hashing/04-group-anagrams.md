...
- **Liên kết tới các bài liên quan:**
  - [valid-anagram](02-valid-anagram.md) - Kiểm tra hai chuỗi có phải anagram không (dùng cùng nguyên lý)
  - [contains-duplicate](01-contains-duplicate.md) - Cũng dùng hash map để nhóm/tìm phần tử
  - [top-k-frequent-elements](05-top-k-frequent-elements.md) - Nhóm và đếm tần suất
